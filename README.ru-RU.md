...
В таком случае разумно загружать модули частично, лениво. Например, предположим, разрабытываемое приложение - это площадка для электронной торговли. Так, мы бы хотели, чтобы админская панель загружалась независимо от пользовательской. Если, например, администратор должен добавить новый продукт, мы бы хотели обеспечить загрузку только необходимого для этого модуля. Это могла бы быть просто страница с доабвлением продукта или вся админская панель, в зависимости от бизнесовой логики приложения.
